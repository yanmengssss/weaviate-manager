...
### 4.2 主控制台 (Dashboard & Tabs & CRUD)

```text
+-------------------------------------------------------------------------------------------------------------+
| [Logo] Data Manager | Tabs: [ MySQL:prod ● ▣ ] [ MySQL:analytics ▲ ▣ ] [ Redis:cache ◆ ▣ ] [ Weaviate:prod ] [+] |
|-------------------------------------------------------------------------------------------------------------|
| Sidebar             |  ## 面板 (按当前标签页变化，彼此独立)                                                    |
|---------------------|----------------------------------------------------------------------------------------|
| - Weaviate Classes  | MySQL:prod                                                                            |
| - MongoDB Databases |  [ SQL Editor ][ Run ] [ Explain ] [ Format ]                                         |
| - MySQL Schemas     |  SELECT * FROM orders LIMIT 50;                                                       |
| - Redis Keyspace    |  -------------------------------------------------------------------                  |
|                     |  id   order_no        amount       created_at                                         |
| [New Connection]    |  ---------------------------------------------------------------                      |
|                     |  1    X2024001        99.00        2024-01-01 12:00:00                                |
|                     |  ...                                                                                            |
|                     |                                                                                            |
|                     | 切换到 MySQL:analytics                                                                   |
...
|                     |  Key                 Type     TTL      Action                                            |
|                     |  ---------------------------------------------------------------                        |
|                     |  session:123         String   3600     [View/Edit][Delete]                              |
|                     |  ...                                                                                            |
+-------------------------------------------------------------------------------------------------------------+
```

## 5. Delivery Checklist (产品评审检查清单)
